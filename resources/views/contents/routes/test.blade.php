                ...
                <div x-show="optimizationResult && showRouteSummary"
                    ...
                    <h2 class="text-xl font-semibold text-gray-800 mb-6 flex items-center">
                        ...
                        <button @click="exportSummary()"
                            class="ml-auto text-sm bg-primary text-white px-3 py-1 rounded-lg hover:bg-opacity-90">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            <template x-for="(step, index) in (optimizationResult?.route_steps || [])"
                                :key="index">
                                <div
                                    class="route-card flex items-center p-4 border rounded-lg hover:shadow-md transition-shadow">
    ...
    <div x-show="loading" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="loading-glass-effect rounded-2xl p-8 text-center max-w-sm mx-4 relative transform">
            <div class="relative mx-auto mb-6">
                <div class="animate-spin rounded-full h-20 w-20 border-4 border-primary border-t-transparent mx-auto">
                </div>
