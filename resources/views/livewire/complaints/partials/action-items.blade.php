{{-- resources/views/livewire/complaints/sections/action-items.blade.php --}}
    ...
    <div class="p-4 sm:p-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div class="bg-gradient-to-br from-red-50 to-red-100 p-4 sm:p-6 rounded-xl border border-red-200">
                ...
                <p class="text-xs sm:text-sm text-red-600">Wymagają działania w ciągu 2h</p>
            </div>
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 p-4 sm:p-6 rounded-xl border border-yellow-200">
                ...
                <p class="text-xs sm:text-sm text-yellow-600">Wymagają działania w ciągu 24h</p>
            </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6 rounded-xl border border-blue-200">
                ...
                <p class="text-xl sm:text-2xl font-bold text-blue-900 mb-1">
                    {{ max(0, $complaintStats['active'] - $complaintStats['open'] - $complaintStats['in_progress']) }}
                </p>
                <p class="text-xs sm:text-sm text-blue-600">Czekają na odpowiedź klienta</p>
            </div>
        </div>
    </div>
</div>