    ...
    <div class="space-y-6 sm:space-y-8">
        ...
        <div x-show="activeTab === 'monthly'" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="grid grid-cols-1 gap-6">
                <div id="status-breakdown-chart" class="h-64 sm:h-80"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div
                ...
                <div id="completion-rate-chart" class="h-48 sm:h-64"></div>
            </div>
            ...
            <div
                ...
                <div id="average-area-chart" class="h-48 sm:h-64"></div>
            </div>
        </div>
    </div>
</div>
