<div class="max-w-[1920px] mx-auto px-6 sm:px-8 lg:px-10 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <button wire:click="$set('statusFilter', 'pending')"
            ...
            @if ($statusFilter === 'pending')
                ...
                <div
                    class="absolute top-full mt-2 right-6 z-10 bg-yellow-600 text-white text-xs font-semibold px-3 py-1.5 rounded-lg shadow-lg whitespace-nowrap">
                    Filtrowanie aktywne
                    <!-- Arrow pointing UP -->
        ...
        <button wire:click="$set('statusFilter', 'in_progress')"
            ...
            @if ($statusFilter === 'in_progress')
                <!-- Tooltip: Bottom Right -->
                <div
                    class="absolute top-full mt-2 right-6 z-10 bg-blue-600 text-white text-xs font-semibold px-3 py-1.5 rounded-lg shadow-lg whitespace-nowrap">
                    Filtrowanie aktywne
                    <!-- Arrow pointing UP -->
        ...
        <button wire:click="$set('statusFilter', 'completed')"
            ...
            @if ($statusFilter === 'completed')
                <!-- Tooltip: Bottom Right -->
                <div
                    class="absolute top-full mt-2 right-6 z-10 bg-green-600 text-white text-xs font-semibold px-3 py-1.5 rounded-lg shadow-lg whitespace-nowrap">
                    Filtrowanie aktywne
                    <!-- Arrow pointing UP -->
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        @forelse($orders as $order)
            ...
            @endphp
            @include('livewire.dashboard.partials.order-card', [
                'order' => $order,
                'cardType' => $cardType,
            ])
        @empty
    ...
    @livewire('dashboard.assign-driver-modal')
</div>
