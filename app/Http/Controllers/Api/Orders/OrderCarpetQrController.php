 ...
 *     description="API Endpoints for Order Carpet QR operationss"
 * )
 */
class OrderCarpetQrController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/api/order-carpets/assign-qr",
     ...
     *
     *         @OA\JsonContent(
     *             required={"carpet_id", "order_carpet_id", "qr_code"},
     *
     *             @OA\Property(property="carpet_id", type="integer", example=1),
