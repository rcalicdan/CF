...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\wamp64\laravel\aladyn-api\aladyn-backend\public\storage' => 'string',
...
'filesystems.links.C:\\wamp64\\laravel\\aladyn-api\\aladyn-backend\\public\\storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.use_absolute_path',
...
'l5-swagger.defaults.scanOptions.pattern','l5-swagger.defaults.scanOptions.exclude','l5-swagger.defaults.scanOptions.open_api_spec_version','l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.type','l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.scheme',
'l5-swagger.defaults.securityDefinitions.securitySchemes.bearerAuth.bearerFormat','l5-swagger.defaults.securityDefinitions.security.0.bearerAuth','l5-swagger.defaults.generate_always','l5-swagger.defaults.generate_yaml_copy','l5-swagger.defaults.proxy',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','passport.token',
...
'passport.scopes.index','passport.personal.tokens.index','passport.personal.tokens.store','passport.personal.tokens.destroy','services.index','services.store',
'services.show','services.update','services.destroy','price-lists.index','price-lists.store',
'price-lists.show','price-lists.update','price-lists.destroy','clients.index','clients.store',
'clients.show','clients.update','clients.destroy','service-price-lists.index','service-price-lists.store',
'service-price-lists.show','service-price-lists.update','service-price-lists.destroy','orders.index','orders.store',
'orders.show','orders.update','order-carpets.index','order-carpets.store','order-carpets.show',
'order-carpets.update','order-carpets.destroy','storage.local',);
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','passport::authorize',);
...
'VITE_APP_NAME','L5_SWAGGER_GENERATE_ALWAYS','SWAGGER_VERSION',);
